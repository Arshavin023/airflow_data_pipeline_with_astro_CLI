...
#         task_id='gcs_to_raw',
#         input_file=File('gs://analytics_bucket/raw/online_retail.csv', conn_id='gcp', filetype=FileType.CSV,),
#         output_table=Table(
#             name='raw_invoices',
#             conn_id='gcp',
...
#     @task_external_python(python='/usr/local/airflow/soda_venv/bin/python')
